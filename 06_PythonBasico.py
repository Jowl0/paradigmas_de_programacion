...
#   nombre:str la vaiable nombre es un str
#============================================
def saludos (nombre:str):
    """Esta funcon te saluda por tu nombre estrictamente"""
    print("!Que onda ese", nombre,"!")
saludos("Julian")
a=123
print(type(a))
...
def saludos_multiples(nombre1, nombre2, nombre3):
    """Esta funcion saluda a 3 pesonas al mismo tienpo"""
