...
#=============================================================
#   Evolucion temporal de la ecuacion difreencial parcial
#   u_t = k*laplaciano(u)   (ecuacion de difucion de calor) 
#=============================================================
...
def solucion (u,un,udx2,dt,n,k):
    for jj in range (1,n[1]-1):
        for ii in range (1,n[0]-1):
            i = ii + n[0]*jj
            #=====================================
            #   Avanza la ecucacion en un punto
            #=====================================
            unueva = evolucion(u,n,udx2,dt,i,k)
            #==================================================
            #   En medio de la mall poner temperatura fija 1
            #==================================================
