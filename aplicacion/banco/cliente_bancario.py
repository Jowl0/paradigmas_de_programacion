...
class ClienteBancario:
    ...
    def __init__(self,nombres:str, apellidos:str, edad:str=0, balanceDeCuenta:float=0.0):
    ...
    #   Si la edad es menor que 18 genera error
    #=============================================
    ...
    def retirarDinero(self,cantidad:float) -> None:
        ...
        self.balanceDeCuenta = cantidadFinal 
