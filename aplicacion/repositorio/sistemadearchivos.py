...
from aplicacion.repositorio.usuario import Usuario 

#==================================================
#  Implemante la interface RepositorioDeUsuarios
#==================================================
...
class SistemaDeArchivos(RepositorioDeUsuarios):
    ...
    def guardar(mi,usuario:Usuario) -> None:
        ...
        print(f"Guardando usuario en el archivo : <{mi__directorio }/{usuario.getNombre()}")
        print(xml)
