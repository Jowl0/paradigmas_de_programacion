...
#============================
#   Funcion pura para x**2
#============================
def alcuadrado(x):
    return x*x

#=============================
#   Funcion pura para x**3
#=============================
...
cuadrados = mapeo(alcuadrado,[2.5,3,3.8,1.2,6.6,1j,7,8])
...
#========================================
temps=[("Berlin",29),("Cairo",36),("Buenos Aires",19),("Los Angeles",26),("Tokyo",27),("Nueva York",28),("Lomdres",22),("Pekin",32),("Mexico Tenochtitlan",23)]
